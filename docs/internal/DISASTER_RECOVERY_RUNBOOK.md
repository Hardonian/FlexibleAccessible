...
3. **Clear Stale Jobs**:
   - BullMQ will automatically re-attempt active jobs when the worker reconnects.
   - If a job is permanently stuck, open `/system/operator` and click "Recheck Status" or drain stale locks.

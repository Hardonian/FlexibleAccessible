...
describe("hasPermission", () => {
  ...
  it("OWNER has all permissions", () => {
    ...
    expect(hasPermission("OWNER", "suggestion:approve")).toBe(true);
  ...
  it("DEVELOPER can start crawls and view findings", () => {
    ...
    expect(hasPermission("DEVELOPER", "finding:view")).toBe(true);
    expect(hasPermission("DEVELOPER", "suggestion:export")).toBe(true);
  });
  ...
  it("CONTENT_EDITOR can view findings and approve suggestions", () => {
    expect(hasPermission("CONTENT_EDITOR", "finding:view")).toBe(true);
    expect(hasPermission("CONTENT_EDITOR", "suggestion:approve")).toBe(true);
  });
  ...
  it("REVIEWER can manage reviews but not export suggestions", () => {
    ...
    expect(hasPermission("REVIEWER", "suggestion:export")).toBe(false);
  });
});
